                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="form form-horizontal" method="POST" action="{{ route('fund_agency.store' ) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_desc" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_interset_percentage" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_repay_period" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_rules" />
                                                                        <span class="text-danger">{{ $errors->first('fund_rules') }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_cost_from" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="fund_cost_to" />
