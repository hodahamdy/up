                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="form form-horizontal" method="POST" action="{{ route('opportunity.store' ) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_name" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_desc" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_contract_duration" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    <div class="col-sm-3">
                                                                        <label class="col-form-label"> copyrights percentage </label>
                                                                    </div>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_copyrights_percentage" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    <div class="col-sm-3">
                                                                        <label class="col-form-label"> opp_markting_percentage </label>
                                                                    </div>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_markting_percentage" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_cost_to" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_location" />
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="opp_rules" />
